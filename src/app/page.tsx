export default function Home() {
  return (
    <main className="relative grid min-h-screen place-items-center overflow-hidden bg-[#050507] px-6 text-center text-white">
      ...
      <section className="relative z-10 animate-[fadeIn_900ms_ease-out_both]">
